object fMonitorSorteio: TfMonitorSorteio
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'Sorteio'
  ...
  object pnlSorteioE: TbsSkinExPanel
    Left = 0
    Top = 0
    Width = 129
    Height = 400
    ...
    object lbSorteio: TbsSkinOfficeListBox
      ...
      Align = alClient
      OnItemCheckClick = lbSorteioItemCheckClick
    end
  end
  object pnlSorteioD: TbsSkinExPanel
    Left = 471
    Top = 0
    Width = 129
    Height = 400
    ...
    OnClose = pnlSorteioDClose
    object lbSorteado: TbsSkinOfficeListBox
      Left = 1
      Top = 21
      Width = 127
      Height = 378
